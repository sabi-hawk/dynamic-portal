...
function AddSchoolStudentModal({
  open,
  setOpen,
  onSuccess,
  editMode = false,
  ...
  // School class options: Nursery, Prep, 1 to 10
  ...
  return (
    <Modal
      title={editMode ? "Edit School Student" : "Add School Student"}
      open={open}
      onOk={() => form.submit()}
      ...
      >
        <Row gutter={16}>
          ...
          <Col span={8}>
            ...
            >
              <Select placeholder="Select Class" options={schoolClassOptions} />
            </Form.Item>
          </Col>
          {/* Gender */}
          <Col span={8}>
